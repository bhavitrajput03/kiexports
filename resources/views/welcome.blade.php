    ...
    <section class="whatwedosection">
        <div class="container">
            <div class="row pb-5" style="align-items: center;">
                <h1 class="text-center mb-5 mt-5">What We Do</h1>
                <div class="col-md-6 mb-5">
                    <div class="wwdsection">
                        <img src="img/Export1.png" width="20%" alt="">
                        <div class="wwdper">
                            <h3>
                                Export
                            </h3>
                            <p>
                                We are Exporting best quality product around the world, You need best product on time
                                you are at right place @ OES Export import
                            </p>
                        </div>
                    </div>
                </div>
                <div class="col-md-6 mb-5">
                    <div class="wwdsection">
                        <img src="img/Import2.png" width="20%" alt="">
                        <div class="wwdper">
                            <h3>
                                Export
                            </h3>
                ...
                <div class="col-md-6">
                    <div class="wwdsection">
                        <img src="img/Sourcing.png" width="20%" alt="">
                        <div class="wwdper">
                            <h3>
                                Export
                            </h3>
                ...
                <div class="col-md-6">
                    <div class="wwdsection">
                        <img src="img/Training.png" width="20%" alt="">
                        <div class="wwdper">
                            <h3>
                                Export
                            </h3>
